...
var recipeEvents = __webpack_require__(5);
...
var onChangePw = function onChangePw(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.changePw(data).then(authUi.passwordPass).catch(authUi.passwordFail);
};
...
var onCreateRecipe = function onCreateRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.createRecipe(data).then(authUi.createRecipeSuccess).catch(authUi.createRecipeFailure);
};
var onGetRecipes = function onGetRecipes(event) {
  ...
  authApi.getRecipes().then(authUi.getRecipesSuccess).catch(authUi.getRecipesFailure);
};
...
// }
var onGetRecipe = function onGetRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  if (data.id === '') {
    authUi.getRecipeFailure();
  } else {
    authApi.getRecipe(data).then(authUi.getRecipeSuccess).catch(authUi.getRecipeFailure);
  }
};
var onUpdateRecipe = function onUpdateRecipe(event) {
  ...
  authApi.updateRecipe(data).then(authUi.updateRecipeSuccess).catch(authUi.updateRecipeFailure);
};
var onDestroyRecipe = function onDestroyRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // const dataId = $(event.target).closest('li').attr('data-id')
  // console.log(dataId)
  authApi.destroyRecipe(data).then(authUi.destroyRecipeSuccess).catch(authUi.destroyRecipeFailure);
};
var onCreateClick = function onCreateClick(event) {
  $('#create').show();
  $('.new-recipe').hide();
  $('#get').hide();
  $('#update').hide();
...
var onUpdateCLick = function onUpdateCLick(event) {
  ...
  authApi.getMyRecipes().then(authUi.getMyRecipesSuccess).catch(authUi.getMyRecipesFailure);
};
...
var onGetClick = function onGetClick(event) {
  $('#update').hide();
  $('.new-recipe').hide();
  $('#create').hide();
  $('#get').show();
...
module.exports = {
  ...
  onDestroyRecipe: onDestroyRecipe
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getRecipe = function getRecipe(data) {
  return $.ajax({
    method: 'GET',
...
var createRecipe = function createRecipe(data) {
...
var updateRecipe = function updateRecipe(data) {
...
var destroyRecipe = function destroyRecipe(data) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/recipes/' + data.id,
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://serene-dusk-64999.herokuapp.com/',
...
var signUpFailure = function signUpFailure(signUpError) {
...
var signInFailure = function signInFailure(signInError) {
...
var signOutFailure = function signOutFailure(signOutError) {
  // console.log('The sign in error is ', signOutError)
  $('#out-fail').modal();
};
var passwordPass = function passwordPass() {
  // console.log('password passed')
  document.getElementById('change-password-dropdown').reset();
  $('#in-success').modal();
};
var passwordFail = function passwordFail() {
  // console.log('password failed')
  document.getElementById('change-password-dropdown').reset();
  $('#pass-fail').modal();
};
var createRecipeSuccess = function createRecipeSuccess(response) {
  ...
  var newHTML = '<h2>New Recipe!</h2><li><h3>' + response['recipe'].name + '</h3><br/><h4> Description: ' + response['recipe'].description + '<br/> Extract: ' + response['recipe'].extract + '<br/>Grains: ' + response['recipe'].grains + '<br/>Hops: ' + response['recipe'].hops + '<br/>Yeast: ' + response['recipe'].yeast + '<br/>Directions: ' + response['recipe'].directions + '</h4></li>';
  $('#get-recipe').show();
  $('#get-recipe').html(newHTML);
};
var createRecipeFailure = function createRecipeFailure(response) {
  // console.log('failure, response is ', response)
  document.getElementById('create-recipe-form').reset();
  $('#create-fail').modal();
};
var getRecipesSuccess = function getRecipesSuccess(response) {
...
var getRecipesFailure = function getRecipesFailure(getRecipesError) {
  // console.log('The get error is ', getRecipesError)
  document.getElementById('get-recipe-form').reset();
  $('#get-fail').modal();
};
var getMyRecipesSuccess = function getMyRecipesSuccess(response) {
...
var getRecipeSuccess = function getRecipeSuccess(response) {
  // console.log('The response is ', response['recipe'].id)
  document.getElementById('get-recipe-form').reset();
  var newHTML = '<li><h3>' + response['recipe'].name + '</h3><br/><h4> Description: ' + response['recipe'].description + '<br/> Extract: ' + response['recipe'].extract + '<br/>Grains: ' + response['recipe'].grains + '<br/>Hops: ' + response['recipe'].hops + '<br/>Yeast: ' + response['recipe'].yeast + '<br/>Directions: ' + response['recipe'].directions + '</h4></li>';
  $('#get-recipe').show();
  $('#get-recipe').html(newHTML);
};
var getRecipeFailure = function getRecipeFailure(getRecipeError) {
  // console.log('The get error is ', getRecipeError)
  document.getElementById('get-recipe-form').reset();
  $('#get-fail').modal();
};
var updateRecipeSuccess = function updateRecipeSuccess(response) {
  // console.log('The response is ', response)
  // $('.new-recipe').show()
  // $('.new-recipe-response').html('Name: ' + response['recipe'].name)
  var newHTML = '<li><h3>' + response['recipe'].name + '</h3><br/><h4> Description: ' + response['recipe'].description + '<br/> Extract: ' + response['recipe'].extract + '<br/>Grains: ' + response['recipe'].grains + '<br/>Hops: ' + response['recipe'].hops + '<br/>Yeast: ' + response['recipe'].yeast + '<br/>Directions: ' + response['recipe'].directions + '</h4></li>';
...
var updateRecipeFailure = function updateRecipeFailure(response) {
  // console.log('The get error is ', response)
  document.getElementById('update-recipe-form').reset();
  $('#update-fail').modal();
};
var destroyRecipeSuccess = function destroyRecipeSuccess(successResponse) {
...
var destroyRecipeFailure = function destroyRecipeFailure(failResponse) {
...
module.exports = {
  ...
  getRecipesSuccess: getRecipesSuccess,
  getRecipesFailure: getRecipesFailure,
  ...
  getMyRecipesSuccess: getMyRecipesSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
